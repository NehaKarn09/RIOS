...
const PulseRate = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const pulserate = last10Data.map(item => item.pulse_rate);

      console.log('Labels:', labels); 
      console.log('Heart Rate Data:', pulserate); 
  ...
  return (
    <div className="flex flex-col items-center p-4">
      <h2 className="text-xl font-bold mb-4">Pulse Rate</h2>
