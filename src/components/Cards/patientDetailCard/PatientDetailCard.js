...
//   return (
//     <div className="w-96 h-40 bg-gray-200 border border-gray-400 rounded-lg shadow-md p-4">
//      <div>
//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Medical Monitor Readings</h3>
//      <p>Heart Rate(HR) : </p>
...
//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Saline Fluid Level</h3>
...
//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Urine Bag Level</h3>
//      <p>Urine level in the bag for the moment : </p>
//      <p>No. of times the urine bag was drained throughout the day : </p>
...
//      <div>
//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Patient's Behaviour</h3>
//      <p>Live camera view : </p>
//      <h6 className="text-xl font-bold mb-1">Abnormal Activity Detection : </h6>
//      <p>Generate Alarm : </p>
//      <p>Sleep Pattern Analysis : </p>
//      </div>

//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Patient Medication Log(EXTRAS)</h3>
//      <p>Doctor's visist for the day : </p>
//      <p>Medicine schedule time line : </p>
//      </div>

//      <div className="mb-6">
//      <h3 className="text-xl font-bold mb-2">Visitors Log(EXTRAS)</h3>
...
// const PatientDetailCard = () => {
//   return (
//     <div className="w-96 bg-gray-200 border border-gray-400 rounded-lg shadow-md p-4">
