...
const AdminDashboard = () => {
    ...
    return (
        <div className="flex flex-wrap items-start justify-center min-h-screen bg-gray-100 gap-4 p-4">
            <div className="flex flex-col w-full md:w-1/3">
                <div className="bg-green-200 text-white rounded-3xl shadow-lg p-6 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
                    <h2 className="text-xl font-bold mb-4">LIST OF HOSPITAL OWNERS</h2>
                    <p className="mb-4">This is a card with a light green background and white text.</p>
                    <Link to="/hospital-owner-detail">
                        <button onClick={handleOwners} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                            View Hospital Owners
                        </button>
                    </Link>
                </div>
                ...
                <div className="bg-green-200 text-white rounded-3xl shadow-lg p-6 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
                    ...
                    <p className="mb-4">This is a card with a light green background and white text.</p>
                    <Link to="/doctor-detail">
                        <button onClick={handleDoctors} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                            View Doctors
                        </button>
                    </Link>
                </div>
            ...
            <div className="flex flex-col w-full md:w-1/3">
                <div className="bg-green-200 text-white rounded-3xl shadow-lg p-6 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
                    ...
                    <p className="mb-4">This is a card with a light green background and white text.</p>
                    <Link to="/staff-detail">
                        <button onClick={handleStaffs} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                            View Staffs
                        </button>
                    </Link>
                </div>
            ...
            <div className="flex flex-col w-full md:w-1/3">
                <div className="bg-green-200 text-white rounded-3xl shadow-lg p-6 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
                    ...
                    <p className="mb-4">This is a card with a light green background and white text.</p>
                    <Link to="/patient-detail">
                        <button onClick={handlePatients} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                            View Patients
                        </button>
                    </Link>
                </div>
                ...
                <div className="bg-green-200 text-white rounded-3xl shadow-lg p-6 mb-4 hover:shadow-2xl transition duration-300 ease-in-out">
                    ...
                    <p className="mb-4">This is a card with a light green background and white text.</p>
                    <Link to="/monitor-patient-detail">
                        <button onClick={monitorPatients} className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline transition duration-300 ease-in-out">
                            Monitor Patients
                        </button>
                    </Link>
                </div>
